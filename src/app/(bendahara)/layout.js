...
const menuItems = [
  ...
  { text: 'Pemasukan', icon: <AccountBalanceWalletIcon />, path: '/bendahara/pemasukan' },
  { text: 'Pengeluaran', icon: <PaymentsIcon />, path: '/bendahara/pengeluaran' },
  { text: 'Laporan Keuangan', icon: <ReceiptIcon />, path: '/bendahara/laporan' },
            ...
            <Grid container spacing={3} alignItems="center" justifyContent="space-between">
              <Grid item xs={12} sm={6}>
                <Typography variant="body2" color={darkMode ? '#fff' : 'text.secondary'} align="left">
                  © {new Date().getFullYear()} Sistem Keuangan Desa
                </Typography>
